...
public class FaseBandeiras extends Jogo {
	...
	String listaCores[] = { "canada", "espanha", "eua", "franca", "italia", "noruega", "suiça", "belgica", "alemanha",
			"finlandia" };
	String url[] = { "/canada.png", "/espanha.png", "/eua.png", "/franca.png", "/italia.png", "/noruega.png",
			"/suiça.png", "/belgica.png", "/alemanha.png", "/finlandia.png" };

	public FaseBandeiras() {
